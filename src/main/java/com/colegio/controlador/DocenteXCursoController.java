...
public class DocenteXCursoController {
	...
	private List<UsuarioxCurso> lstDocentexCurso;
	

	public List<UsuarioxCurso> getLstDocentexCurso() {
		return lstDocentexCurso;
	}

	public void setLstDocentexCurso(List<UsuarioxCurso> lstDocentexCurso) {
		this.lstDocentexCurso = lstDocentexCurso;
	}
...
//	}
	...
	public String metVerSintomas() {
		...
		try {
			urlForGetRequest = new URL("http://localhost:8080/WS_REST_Servidor/rest/servicios/docentexCurso");
	...
	@RequestMapping("/cargaDocenteXCurso")
	@ResponseBody
	public List<UsuarioxCurso> lista() {
		return lstDocentexCurso;//servicio.listaTriaje();
	}
...
public int PUTRequest(String POST_PARAMS,String url) throws IOException {
    ...
    return responseCode;
		...
		@RequestMapping("/saveDocenteXCurso")
		public String metsaveCurso(UsuarioxCurso bean, Model m) {
			...
			return "redirect:verDocenteXCurso";
		}
