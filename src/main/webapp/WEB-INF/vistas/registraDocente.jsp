...
<div class="wrapper">
			...
			<div class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true" id="idModalSave">
			        <div class="modal-dialog" style="width: 60%" role="document">
			            ...
			            <div class="modal-body">
			                    <form id="id_form_save" action="saveDocente" class="form-horizontal" accept-charset="UTF-8">
			                            <!-- Step 1 -->
												<div class="card">
	...
	<div class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true" id="idModalActualiza">
        <div class="modal-dialog" style="width: 60%" role="document">
            ...
            <div class="modal-content">
            <div class="modal-body">
                    <form id="id_form_actualiza" action="updateDocente" class="form-horizontal"  accept-charset="UTF-8">
                            <!-- Step 1 -->
                            <div class="card">
                                <div class="card-header">
