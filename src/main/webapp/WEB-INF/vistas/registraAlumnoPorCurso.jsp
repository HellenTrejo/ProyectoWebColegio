    ...
    <div class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true" id="idModalActualiza">
			        <div class="modal-dialog" style="width: 60%" role="document">
			            ...
			            <div class="modal-body">
			                    <form id="id_form_actualiza" action="saveAlumnoXCurso" class="form-horizontal"  accept-charset="UTF-8">
			                            <!-- Step 1 -->
												<div class="card">
													...
													<div class="card-body">
														...
														<div class="form-group">
															<label class="col-lg-5 control-label" for="id_act_doc">Alumno</label>
															<div class="col-lg-12">
...
function ListarDocente(){
	$.getJSON("cargaAlumno", {}, function(data){
		...
		$.each(data, function(index,item){
			$("#id_act_doc").append("<option value="+item.idUsuario +">"+ item.apellido +" "+ item.nombre +"</option>");
		});
	});
}
