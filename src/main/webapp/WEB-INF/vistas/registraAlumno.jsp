			            ...
			            <div class="modal-body">
			                    <form id="id_form_save" action="saveAlumno" class="form-horizontal"  accept-charset="UTF-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <input class="form-control" id="id_reg_correo" name="correo" placeholder="Ingrese el correo" type="text" pattern="\b[\w\.-]+@[\w\.-]+\.\w{2,4}\b" title="Requiere el formato: email@direccion.com" required/>
                                            </div>
                                        </div>
